...
const Csslogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} width="800px" height="800px" viewBox="0 0 538.584 538.584" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M269.168 239.656l-97.49 40.602 3.233 40.199 94.257-40.301 100.265-42.868 4.157-41.122-104.422 43.49z" fill="#ffffff"/>
