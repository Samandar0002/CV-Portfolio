...
const Andesign: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} fill="#000000" width="800px" height="800px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" className="icon">
