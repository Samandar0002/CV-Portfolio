...
const JSlogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props}fill="none" height="2500" width="2183" viewBox="0 0 124 141.53199999999998" xmlns="http://www.w3.org/2000/svg">
